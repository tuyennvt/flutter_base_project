...
/// @nodoc
mixin _$MainState {
  AsyncValue<List<Post>> get posts => throw _privateConstructorUsedError;
...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<Post>> posts});
}
...
class _$_MainState implements _MainState {
  const _$_MainState({this.posts = const AsyncValue.loading()});
...
abstract class _MainState implements MainState {
  const factory _MainState({final AsyncValue<List<Post>> posts}) = _$_MainState;
